...
function AppointmentComponent({closeComponent, isActive}){
    ...
    return (<>
        <section className={`w-full h-screen bg-[#161615ba] fixed bottom-0 left-0 z-50 flex items-center justify-center transition-all duration-500 overflow-hidden ${isActive ? "top-0" : "top-full"}`}>
